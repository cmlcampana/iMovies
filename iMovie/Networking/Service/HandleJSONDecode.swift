...
public protocol HandleJSONDecode {
    func handleJSONDecode<T: Decodable>(data: Data, keyDecodingStrategy: JSONDecoder.KeyDecodingStrategy, result: ResultHandler<T>)
}

public extension HandleJSONDecode {
    ...
    func handleJSONDecode<T: Decodable>(
        data: Data,
